...
class LibraryPage(QWidget):
    ...
    Signals:
        load_folder_requested(): the "Load Folder" button was clicked.
            ...
            starting a real scan (out of scope for this wiring phase).
    ...
    def _build_header(self) -> QVBoxLayout:
        ...
        self._load_folder_button.setObjectName("LoadFolderButton")
    ...
    def set_load_folder_button_enabled(self, enabled: bool) -> None:
        """
        Enable/disable the "Carica cartella" button. Used by MainWindow
        to prevent starting a second ScannerWorker while one is already
        running against the same (single, shared) database connection.
        """
